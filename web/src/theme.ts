...
const baseComponents: ThemeConfig['components'] = {
  ...
  Input: { controlHeight: 36, activeShadow: '0 0 0 3px rgba(78,134,255,.18)', paddingInline: 12 },
  ...
  Tabs: { titleFontSize: 14, inkBarColor: BRAND.blue, itemSelectedColor: BRAND.blue },
  Modal: { borderRadiusLG: 14, titleFontSize: 17 },
...
export function makeTheme(mode: ThemeMode = 'light'): ThemeConfig {
  ...
  return {
    ...
    components: {
      ...
      Form: { labelColor: dark ? '#9DB0CE' : '#42536F', labelFontSize: 13, verticalLabelPadding: '0 0 4px' },
